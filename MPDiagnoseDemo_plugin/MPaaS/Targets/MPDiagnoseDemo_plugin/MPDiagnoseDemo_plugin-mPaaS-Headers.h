//
//  MPDiagnoseDemo_plugin-mPaaS-Headers.h
...
#ifndef MPDiagnoseDemo_plugin_mPaaS_Headers_h
#define MPDiagnoseDemo_plugin_mPaaS_Headers_h
...
#endif /* MPDiagnoseDemo_plugin_mPaaS_Headers_h */
